...
describe('It routes bad points', function () {
   describe('Routing', function () {
       seattlePairs.forEach((pair) => {
          ...
          it('gets a valid route response', async function (done) {
              const response = await axios.get(`http://localhost:5000/route/v1/driving/${lon1},${lat1};${lon2},${lat2}?overview=false&alternative=false&steps=true`);
          //    http://localhost:5000/route/v1/driving/-121.497803,48.004625;-122.387695,46.362093?overview=false&alternatives=true&steps=true&hints=;
          });
       });
   })
});
